...
urlpatterns = [
    ...
    path("ingredient/remove", views.remove_ingredients, name="remove_ingredients"),
    path("ingredient/add", views.add_ingredient, name="add_ingredient"),
    path(
        "ingredient/edit/<int:ingredient_number>",
        views.edit_ingredient,
        name="edit_ingredient",
    ),
    # Formula Views
    path("formula/edit/<int:formula_number>", views.edit_formula, name="edit_formula"),
    path(
        "formula/edit/<str:formula_name>",
        views.edit_formula_name,
        name="edit_formula_name",
    ),
    path("formula/add", views.add_formula, name="add_formula"),
    path("formula/view/<int:formula_number>", views.view_formula, name="view_formula"),
    path("formula", views.formula, name="formula"),
    path("formula/remove", views.remove_formulas, name="remove_formulas"),
    # Import/export views
    ...
    path("goal/enable", views.enable_goals, name="enable_goals"),
    path("goal/disable", views.disable_goals, name="disable_goals"),
    ...
    path("lines/skus/view", views.view_lines, name="view_lines"),
    path("lines/skus/edit", views.edit_lines, name="edit_lines"),
